...
function AddnewRowstepsUpdate(preparationId) {
    ...
    console.log("Step cells length:", stepCells.length); // Debugging log


    var lastCell = stepCells[stepCells.length - 1];
    console.log("Step lastCell length:", lastCell); // Debugging log

    var lastStepIDInput = lastCell ? lastCell.querySelector(`input[name$="PrepStepsID"]`) : null;
    ...
    newCell.innerHTML = `
        <input type="hidden" name="stepsVM[${newRowIndex}].PreparationsFK" value="${preparationId}" />
        <input type="hidden" name="stepsVM[${newRowIndex}].PrepStepsNum" value="${currentStep1Value}" />
        <input type="hidden" name="stepsVM[${newRowIndex}].PrepStepsID" value="${currentIDValue}" />
        <input type="hidden" name="stepsVM[${newRowIndex}].PrepImage"  data-preview-id="${currentIDValue}" />
         ...
         <div class="row">
            <div class="col-12 text-center">
                ...
                <div class="form-group mt-2">
                    ...
                    <textarea class="form-control mt-2" id="stepsVM_${currentIDValue}" name="stepsVM[${currentIDValue}].PrepText"></textarea>
                </div>
            </div>
        </div>
    `;
...
//صفحة الاضافة..
var currentStep1Value = 1; // Initialize step number
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <div class="form-group mt-2">
                    ...
                    <textarea class="form-control mt-2" id="stepsVM_${currentStep1Value}" name="stepsVM[${clickCount}].PrepText"></textarea>
                </div>
            </div>
        </div>
    `;
